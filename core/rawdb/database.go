...
// [bsc] Ancients returns an error as we don't have a backing chain freezer.
...
// [bsc] added function to support real time pruning
...
// storage.
// [bsc] improved new db with freezer, by adding freezer disabling & offset start
